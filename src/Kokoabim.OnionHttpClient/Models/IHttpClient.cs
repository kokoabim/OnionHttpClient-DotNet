...
public interface IHttpClient : IDisposable
{
    ...
    IHttpClientResponse GetResponse(HttpRequestMessage request, CancellationToken cancellationToken = default);
    Task<IHttpClientResponse> GetResponseAsync(HttpRequestMessage request, CancellationToken cancellationToken = default);

    HttpResponseMessage Send(HttpRequestMessage request, CancellationToken cancellationToken = default);
    Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken = default);
}

/* Interface for System.Net.Http.HttpClient
public interface IHttpClient : IDisposable
{
